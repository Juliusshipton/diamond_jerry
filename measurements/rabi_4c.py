...
class Rabi(Pulsed):
    ...
    switch = Enum('mw_x', 'mw_y', 'mw_bx', 'mw_by', desc='switch to use for different microwave source', label='switch')
    ...
    def start_up(self):
        ...
        if self.switch == 'mw_x' or self.switch == 'mw_y':
            ha.MicrowaveA().setOutput(self.power, self.frequency)
        elif self.switch == 'mw_bx' or self.switch == 'mw_by':
