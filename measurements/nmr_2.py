...
class NMR(Pulsed):
    ...
    seconds_per_point = Range(low=0.1, high=10., value=0.8, desc='Seconds per point', label='Seconds per point', mode='text', auto_set=False, enter_set=True)
    ...
    def generate_sequence(self):
        ...
        return 100 * [ (['laser', 'aom'], self.laser), ([], self.wait), (['mw_b'], self.t_pi_B), (['rf'], self.rf_t_pi), ([], 500), (['aom'], self.laser), ([], self.wait), (['mw_x'], self.t_pi_A), (['rf'], self.rf_t_pi), ([], 500), (['mw_x'], self.t_pi_A), (['sequence'], 10) ]
    ...
    def _run(self):
        ...
        try: # try to run the acquisition from start_up to shut_down
            ...
            ha.MicrowaveE().setOutput(self.mwB_power, self.mwB_frequency)
            ...
            ha.MicrowaveE().setOutput(None, self.mwB_frequency)
