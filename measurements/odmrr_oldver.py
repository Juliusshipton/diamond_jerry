...
class ODMRR(ManagedJob, GetSetItemsMixin):
    ...
    seconds_per_point = Range(low=20e-3, high=1, value=10e-3, desc='Seconds per point', label='Seconds per point', mode='text', auto_set=False, enter_set=True)
...
#'''ends here'''
    ...
    traits_view = View(VGroup(HGroup(Item('submit_button', show_label=False),
                              ...
                              VGroup(HGroup(Item('power', width= -40, enabled_when='state != "run"'),
									 ...
									 # HGroup(Item('nonuniform', enabled_when='state != "run"'),
                       ...
                       menubar=MenuBar(Menu(Action(action='saveLinePlot', name='SaveLinePlot (.png)'),
                                              ...
                                              name='File')),
                       title='ODMRR', width=900, height=800, buttons=[], resizable=True, handler=ODMRHandler
                       )
