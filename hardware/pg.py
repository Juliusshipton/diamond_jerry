...
class Communicate(threading.Thread):
    ...
    def run(self):
        while True:
            ...
            UDPSock.close()
            self.addr = addr
            if data == 'Cycle started.':
                print "data recieved... (" + str(datetime.now()) + ")"
                with open('pulsepattern.txt', 'r') as file:
                    pulsepattern = file.read()
                pulsepattern = pulsepattern.split('\n')
                ###Load Pattern
                for lines in pulsepattern:
                    exec(lines)
                #pg.setContinuous(['ch0'])
                pg.setSequence(pattern, loop, triggered)
                #
                ###Reset Trigger
                pg.run(triggered=True)
                #
                #pg.setSequence(1000*[(['ch8'],10000),(['ch1','ch11'],50000),([],30000),(['ch2'],80000),([],2000000-10000-50000-30000-80000-1882)],loop=False)

                
                #PG.setContinuous(0xffff)
...
class PulseGenerator():
    ...
    def __init__(self, serial='', channel_map={'ch0':0,'ch1':1,'ch2':2,'ch3':3,'ch4':4,'ch5':5,'ch6':6,'ch7':7,'ch8':8,'ch9':9,'ch10':10,'ch11':11,'ch12':12,'ch13':13,'ch14':14,'ch15':15,'ch16':16,'ch17':17,'ch18':18,'ch19':19,'ch20':20,'ch21':21,'ch22':22,'ch23':23}, core='24x4'):
        self.serial = serial
...
#        self.xem.SetWireInValue(0x02,self.command_map[command])
...
if __name__ == '__main__':
    ...
    pg = PulseGenerator()
    #pg.setSequence(1000*[(['ch0'],50000),([],50000)])
    ...
    #sequence = 10 * [ (['ch0'],1000.), ([],10000.), (['ch1'],1000.)]
    #sequence = 1000*[(['ch2'],100.),(['ch2','ch4','ch0','ch1','ch3'],100.),(['ch2','ch4','ch0','ch1','ch3'],100.),([],1000.)]+[([],10000)]
    #sequence2 = 1000 * [(['ch0'],6.),(['ch0','ch1'],6.),(['ch0','ch1','ch2'],6.),(['ch0','ch1','ch2','ch3'],6.),(['ch0','ch1','ch2','ch3','ch4'],6.),(['ch0','ch1','ch2','ch3','ch4','ch5'],6.),(['ch0','ch1','ch2','ch3','ch4','ch5','ch6'],6.),(['ch0','ch1','ch2','ch3','ch4','ch5','ch6','ch7'],6.),(['ch0','ch1','ch2','ch3','ch4','ch5','ch6','ch7','ch8'],6.),(['ch0','ch1','ch2','ch3','ch4','ch5','ch6','ch7','ch8','ch9'],6.),(['ch0','ch1','ch2','ch3','ch4','ch5','ch6','ch7','ch8','ch9','ch10'],6.),(['ch0','ch1','ch2','ch3','ch4','ch5','ch6','ch7','ch8','ch9','ch10','ch11'],6.),(['ch1','ch2','ch3','ch4','ch5','ch6','ch7','ch8','ch9','ch10','ch11'],6.),(['ch2','ch3','ch4','ch5','ch6','ch7','ch8','ch9','ch10','ch11'],6.),(['ch3','ch4','ch5','ch6','ch7','ch8','ch9','ch10','ch11'],6.),(['ch4','ch5','ch6','ch7','ch8','ch9','ch10','ch11'],6.),(['ch5','ch6','ch7','ch8','ch9','ch10','ch11'],6.),(['ch6','ch7','ch8','ch9','ch10','ch11'],6.),(['ch7','ch8','ch9','ch10','ch11'],6.),(['ch8','ch9','ch10','ch11'],6.),(['ch9','ch10','ch11'],6.),(['ch10','ch11'],6.),(['ch11'],6.),([],6.),([],1000.)]+[([],10000)]
    #sequence24 = [(['ch23'],100)] + 1000 * [(['ch0'],6.),(['ch0','ch1'],6.),(['ch0','ch1','ch2'],6.),(['ch0','ch1','ch2','ch3'],6.),(['ch0','ch1','ch2','ch3','ch4'],6.),(['ch0','ch1','ch2','ch3','ch4','ch5'],6.),(['ch0','ch1','ch2','ch3','ch4','ch5','ch6'],6.),(['ch0','ch1','ch2','ch3','ch4','ch5','ch6','ch7'],6.),(['ch0','ch1','ch2','ch3','ch4','ch5','ch6','ch7','ch8'],6.),(['ch0','ch1','ch2','ch3','ch4','ch5','ch6','ch7','ch8','ch9'],6.),(['ch0','ch1','ch2','ch3','ch4','ch5','ch6','ch7','ch8','ch9','ch10'],6.),(['ch0','ch1','ch2','ch3','ch4','ch5','ch6','ch7','ch8','ch9','ch10','ch11'],6.),(['ch0','ch1','ch2','ch3','ch4','ch5','ch6','ch7','ch8','ch9','ch10','ch11','ch12'],6.),(['ch0','ch1','ch2','ch3','ch4','ch5','ch6','ch7','ch8','ch9','ch10','ch11','ch12','ch13'],6.),(['ch0','ch1','ch2','ch3','ch4','ch5','ch6','ch7','ch8','ch9','ch10','ch11','ch12','ch13','ch14'],6.),(['ch0','ch1','ch2','ch3','ch4','ch5','ch6','ch7','ch8','ch9','ch10','ch11','ch12','ch13','ch14','ch15'],6.),(['ch0','ch1','ch2','ch3','ch4','ch5','ch6','ch7','ch8','ch9','ch10','ch11','ch12','ch13','ch14','ch15','ch16'],6.),(['ch0','ch1','ch2','ch3','ch4','ch5','ch6','ch7','ch8','ch9','ch10','ch11','ch12','ch13','ch14','ch15','ch16','ch17'],6.),(['ch0','ch1','ch2','ch3','ch4','ch5','ch6','ch7','ch8','ch9','ch10','ch11','ch12','ch13','ch14','ch15','ch16','ch17','ch18'],6.),(['ch0','ch1','ch2','ch3','ch4','ch5','ch6','ch7','ch8','ch9','ch10','ch11','ch12','ch13','ch14','ch15','ch16','ch17','ch18','ch19'],6.),(['ch0','ch1','ch2','ch3','ch4','ch5','ch6','ch7','ch8','ch9','ch10','ch11','ch12','ch13','ch14','ch15','ch16','ch17','ch18','ch19','ch20'],6.),(['ch0','ch1','ch2','ch3','ch4','ch5','ch6','ch7','ch8','ch9','ch10','ch11','ch12','ch13','ch14','ch15','ch16','ch17','ch18','ch19','ch20','ch21'],6.),(['ch0','ch1','ch2','ch3','ch4','ch5','ch6','ch7','ch8','ch9','ch10','ch11','ch12','ch13','ch14','ch15','ch16','ch17','ch18','ch19','ch20','ch21','ch22'],6.),(['ch1','ch2','ch3','ch4','ch5','ch6','ch7','ch8','ch9','ch10','ch11','ch12','ch13','ch14','ch15','ch16','ch17','ch18','ch19','ch20','ch21','ch22'],6.),(['ch2','ch3','ch4','ch5','ch6','ch7','ch8','ch9','ch10','ch11','ch12','ch13','ch14','ch15','ch16','ch17','ch18','ch19','ch20','ch21','ch22'],6.),(['ch3','ch4','ch5','ch6','ch7','ch8','ch9','ch10','ch11','ch12','ch13','ch14','ch15','ch16','ch17','ch18','ch19','ch20','ch21','ch22'],6.),(['ch4','ch5','ch6','ch7','ch8','ch9','ch10','ch11','ch12','ch13','ch14','ch15','ch16','ch17','ch18','ch19','ch20','ch21','ch22'],6.),(['ch5','ch6','ch7','ch8','ch9','ch10','ch11','ch12','ch13','ch14','ch15','ch16','ch17','ch18','ch19','ch20','ch21','ch22'],6.),(['ch6','ch7','ch8','ch9','ch10','ch11','ch12','ch13','ch14','ch15','ch16','ch17','ch18','ch19','ch20','ch21','ch22'],6.),(['ch7','ch8','ch9','ch10','ch11','ch12','ch13','ch14','ch15','ch16','ch17','ch18','ch19','ch20','ch21','ch22'],6.),(['ch8','ch9','ch10','ch11','ch12','ch13','ch14','ch15','ch16','ch17','ch18','ch19','ch20','ch21','ch22'],6.),(['ch9','ch10','ch11','ch12','ch13','ch14','ch15','ch16','ch17','ch18','ch19','ch20','ch21','ch22'],6.),(['ch10','ch11','ch12','ch13','ch14','ch15','ch16','ch17','ch18','ch19','ch20','ch21','ch22'],6.),(['ch11','ch12','ch13','ch14','ch15','ch16','ch17','ch18','ch19','ch20','ch21','ch22'],6.),(['ch12','ch13','ch14','ch15','ch16','ch17','ch18','ch19','ch20','ch21','ch22'],6.),(['ch13','ch14','ch15','ch16','ch17','ch18','ch19','ch20','ch21','ch22'],6.),(['ch14','ch15','ch16','ch17','ch18','ch19','ch20','ch21','ch22'],6.),(['ch15','ch16','ch17','ch18','ch19','ch20','ch21','ch22'],6.),(['ch16','ch17','ch18','ch19','ch20','ch21','ch22'],6.),(['ch17','ch18','ch19','ch20','ch21','ch22'],6.),(['ch18','ch19','ch20','ch21','ch22'],6.),(['ch19','ch20','ch21','ch22'],6.),(['ch20','ch21','ch22'],6.),(['ch21','ch22'],6.),(['ch22'],6.),([],6.),([],1000.)]+[([],10000)]
    #sequence3 = [(['ch23'],100)] + 1000 * [(['ch0','ch1','ch2','ch3','ch4','ch5','ch6','ch7','ch8','ch9','ch10','ch11','ch12','ch13','ch14','ch15','ch16','ch17','ch18','ch19','ch20','ch21','ch22','ch23'],6.),([],1000.)]+[([],10000)]



    #sequence3 = 1000*[(['ch0'],6.),([],1000.)]+[([],10000)]
    #pg.setSequence(sequence24)
